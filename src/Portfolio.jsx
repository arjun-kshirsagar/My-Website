...
export { greeting, socialMediaLinks, skillsSection, techStack, openSource, achievementSection, blogSection, talkSection, podcastSection, contactInfo , twitterDetails};